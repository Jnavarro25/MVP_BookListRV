...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolderData>
    ...
    class ViewHolderData extends RecyclerView.ViewHolder {
        ...
        private void dataAsign(Book book) {
            ...
            bookTitle.setText(MyApp.getContext().getString(R.string.book_title,book.getTitle()));
            authorName.setText(MyApp.getContext().getString(R.string.author_name,book.getAuthorFirstName(),book.getAuthorLastName()));
            category.setText(MyApp.getContext().getString(R.string.category,book.getCategory()));
        }
    }
}
